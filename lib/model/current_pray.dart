...
//
//     final CurrentPray = CurrentPrayFromJson(jsonString);

import 'dart:convert';

CurrentPray CurrentPrayFromJson(String str) => CurrentPray.fromJson(json.decode(str));

String CurrentPrayToJson(CurrentPray data) => json.encode(data.toJson());
...
class CurrentPray {
  ...
  factory CurrentPray.fromJson(Map<String, dynamic> json) => CurrentPray(
    code: json["code"],
    status: json["status"],
